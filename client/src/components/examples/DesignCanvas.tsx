  ...
  const mockDesigns = [
    {
      ...
      html: `
        <div style="padding: 24px; font-family: Inter, sans-serif;">
          <h1 style="font-size: 28px; font-weight: 700; margin-bottom: 16px; color: #6366f1;">Genius UI</h1>
    ...
    },
    {
      ...
      html: `
        <div style="padding: 64px; font-family: Inter, sans-serif; max-width: 1200px; margin: 0 auto;">
          <h1 style="font-size: 48px; font-weight: 700; margin-bottom: 24px; color: #6366f1;">Genius UI</h1>
